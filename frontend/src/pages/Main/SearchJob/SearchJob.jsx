    ...
    const loadJobPosts = async () => {
      try {
        ...
        if (selectedEmploymentType)
          params.employmentTypeId = selectedEmploymentType;
  ...
  const renderActiveFilters = () => {
    ...
    if (selectedField) {
      ...
      filters.push(
        <Badge
          ...
          bg="light"
          text="dark"
          className={`me-2 mb-2 p-2 ${styles["animated-badge"]}`}
        >
    ...
    if (selectedEmploymentType) {
      const type = employmentTypes.find(
        (t) => t.value === selectedEmploymentType
      );
      filters.push(
        <Badge
          key="type"
        ...
        <div className="d-flex justify-content-between align-items-center mb-2">
          <div className="text-muted d-flex align-items-center">
            ...
            <span style={{ fontWeight: 500 }}>
              Bộ lọc đang áp dụng ({filters.length}):
            </span>
          </div>
          {filters.length > 1 && (
            <Button
  ...
  return (
    <>
      ...
      <Container fluid className="p-0">
            ...
            <Row>
              <Col>
                <div className="d-flex align-items-center">
                  <Link
                    to={"/"}
                    className={`${styles["breadcrumb-item"]} text-muted d-flex align-items-center`}
                    style={{ fontSize: "0.9rem", cursor: "pointer" }}
                  >
                    <i className="bi bi-house-door me-1"></i> Trang chủ
                  </Link>
                  <i
                    className="bi bi-chevron-right mx-2"
                    style={{ fontSize: "0.7rem", color: "#aaa" }}
                  ></i>
                  <span
                    className={`${styles["breadcrumb-item"]} fw-medium`}
                    style={{ fontSize: "0.9rem", color: "#00b14f" }}
                  >
                    Tìm kiếm việc làm
                  </span>
                </div>
                ...
                >
                  <i
                    className="bi bi-search-heart me-2"
                    style={{ color: "#00b14f" }}
                  ></i>
                  Tìm thấy{" "}
                  <span
                  ...
                  việc làm phù hợp với nhu cầu của bạn
                </p>
              </Col>
            </Row>
          </Container>
        ...
        <div
          className={`py-2 px-3 px-md-5 ${styles["fade-in-up"]}`}
          style={{
            background: "linear-gradient(to right, #e6f7ef, #f2fcf8)",
            borderBottom: "1px solid #d1f3e0",
          }}
        >
          <Container>
            <Row>
        ...
        <Container className="py-4">
          <Row className="mb-4">
            <Col lg={12} className="mb-3">
              <Card
                className={`mb-3 shadow border-0 ${styles["shadow-hover-card"]}`}
                style={{ borderRadius: "16px", overflow: "hidden" }}
              >
                <Card.Body className="p-4">
                  <Form.Group>
                    <div
                      className={`d-flex flex-column flex-md-row align-items-center gap-3 ${styles["search-container"]}`}
                    >
                      <div className="position-relative flex-grow-1 w-100">
                        {" "}
                        <div
                          className={`position-absolute ${styles["search-icon-container"]}`}
                          style={{
                            left: "16px",
                            top: "13px",
                            color: "#00b14f",
                      ...
                      <Button
                        ...
                        onMouseOver={(e) => {
                          ...
                          e.target.style.boxShadow =
                            "0 6px 15px rgba(0, 177, 79, 0.35)";
                        }}
                        onMouseOut={(e) => {
                          e.target.style.backgroundColor = "#00b14f";
                          e.target.style.transform = "translateY(0)";
                          e.target.style.boxShadow =
                            "0 4px 10px rgba(0, 177, 79, 0.25)";
                        }}
                        onClick={() => {
                    ...
                    {keyword && (
                      <div className="mt-3 text-muted small d-flex align-items-center animate__animated animate__fadeIn">
                        <span className="bg-light py-1 px-3 rounded-pill">
                          ...
                          Đang tìm kiếm:{" "}
                          <strong
                            className={styles["search-highlight"]}
            ...
            <Col lg={3}>
              <Card
                className={`mb-4 border-0 shadow ${styles["shadow-hover-card"]} ${styles["modern-card"]}`}
                style={{
                  borderRadius: "16px",
                  position: "sticky",
                  top: "20px",
              ...
              >
                    ...
                    >
                      ...
                      {activeFiltersCount() > 0 && (
                        <Badge
                          pill
                          bg="success"
                          className="ms-2 animate__animated animate__fadeIn"
                          style={{
                            backgroundColor: "#00b14f",
                ...
                <Card.Body
                  className={`p-4 ${styles["filter_body"]}`}
                ...
                >
                  <div className={`mb-4 ${styles["filter-section"]}`}>
                    ...
                    >
                      <div
                        className={`${styles["filter-icon"]} me-2`}
                        style={{
                    ...
                    <div>
                        ...
                        styles={{
                          control: (provided, state) => ({
                            ...
                            boxShadow: state.isFocused
                              ? "0 0 0 0.25rem rgba(0, 177, 79, 0.25)"
                              : "none",
                            borderRadius: "12px",
                            minHeight: "45px",
                            transition: "all 0.2s",
                      ...
                      {selectedField && (
                        <div
                          className="mt-2 small animate__animated animate__fadeIn"
                          style={{ color: "#00b14f", fontSize: "13px" }}
                        >
                        ...
                        >
                          ...
                          </span>{" "}
                          {
                            employmentTypes.find(
                              (option) =>
                                option.value === selectedEmploymentType
                            )?.label
                          }
                        </div>
                      )}
                  ...
                  <div className={`mb-4 ${styles["filter-section"]}`}>
                    ...
                    {selectedLocation && (
                      ...
                      >
                        <i className="bi bi-check-circle-fill me-1"></i>
                        <span style={{ fontWeight: "500" }}>Đã chọn:</span>{" "}
                        {selectedLocation}
                      </div>
                    )}
                    <div className="mt-3">
                        ...
                        {popularLocations.slice(0, 5).map((location, index) => (
                          <span
                            ...
                            style={{
                              fontSize: "13px",
                              fontWeight:
                                selectedLocation === location ? "500" : "400",
                              cursor: "pointer",
                              transition: "all 0.3s ease",
                              margin: "3px",
                              boxShadow:
                                selectedLocation === location
                                  ? "0 3px 10px rgba(0, 177, 79, 0.2)"
                                  : "0 2px 5px rgba(0,0,0,0.03)",
                  ...
                  <div className={`mb-4 ${styles["filter-section"]}`}>
                    ...
                    <div className="mt-3">
                      <div className="d-flex flex-wrap gap-2">
                        ...
                        <span
                          className={`badge rounded-pill px-3 py-2 ${
                            selectedSalary === "10000000-20000000"
                        ...
                        <span
                          className={`badge rounded-pill px-3 py-2 ${
                            selectedSalary === "20000000-30000000"
                              ? "bg-light border border-success text-success"
                              : "bg-light text-secondary"
                          }`}
                          style={{
                        ...
                        <span
                          className={`badge rounded-pill px-3 py-2 ${
                            selectedSalary === "30000000-50000000"
                              ? "bg-light border border-success text-success"
                              : "bg-light text-secondary"
                          }`}
                          style={{
                  ...
                  <Card
                    className={`mt-4 border-0 shadow ${styles["shadow-hover-card"]}`}
                    style={{ borderRadius: "16px", overflow: "hidden" }}
                  >
                    <Card.Header
                      className="bg-white border-bottom py-3"
                    ...
                    <Card.Body className="p-3">
                      <div className="d-flex flex-column gap-2">
                        {" "}
                        <div
                          className={`${styles["job-info-tag"]} w-100 justify-content-between`}
                          style={{
                            cursor: "pointer",
                            padding: "10px 15px",
                            margin: "2px 0",
                  ...
                  {/* Công ty hàng đầu */}
                  <Card
                    className={`mt-3 border-0 shadow ${styles["shadow-hover-card"]}`}
                    style={{ borderRadius: "16px", overflow: "hidden" }}
                  >
                    <Card.Header
                      className="bg-white border-bottom py-3"
                        ...
                        {topCompanies.length > 0 ? (
                          topCompanies.map((company, index) => (
                            ...
                            >
                              ...
                              {company.companyName}
                              <span className="ms-2 badge bg-success bg-opacity-10 text-success">
                          ...
                          <span className="text-muted">
                            Không có dữ liệu công ty nổi bật
                          </span>
                        )}
                      </div>
                    </Card.Body>
            ...
            <Col lg={9}>
              <Card
                className={`border-0 shadow ${styles["shadow-hover-card"]} ${styles["modern-card"]}`}
                style={{ borderRadius: "16px", overflow: "hidden" }}
              >
                <Card.Header
                  className="bg-white border-bottom d-flex justify-content-between align-items-center py-3 px-4"
                  style={{
                ...
                >
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <div className="mt-1 d-flex align-items-center flex-wrap gap-2">
                        <span
                          className={`text-muted ${styles["fade-in-up"]}`}
                          style={{ fontSize: "14px", animationDelay: "0.1s" }}
                        >
                          Tìm thấy{" "}
                          <span style={{ color: "#00b14f", fontWeight: "700" }}>
                            {totalCount}
                          </span>{" "}
                          việc làm
                        </span>
                        {activeFiltersCount() > 0 && (
                          <span
                            className={`badge bg-primary bg-opacity-10 text-primary rounded-pill ${styles["fade-in-up"]}`}
                            style={{ fontSize: "13px", animationDelay: "0.2s" }}
                          >
                  ...
                  <div className="d-flex align-items-center">
                    <div
                      className="bg-light rounded-pill d-flex align-items-center px-3 py-1 me-2 d-none d-md-flex"
                      style={{
                        border: "1px solid #eee",
                        background:
                ...
                <Card.Body className="p-3">
                  <div className={styles.seach}>
                    {isLoading ? (
                      <div
                        className={`text-center py-5 ${styles["loading-container"]}`}
                      >
                        <div
                        ...
                        >
                          ...
                          <div
                            className="spinner-border position-absolute top-0 start-50 translate-middle-x"
                            role="status"
                            style={{
                              color: "#0b7ed0",
                              width: "2rem",
                        ...
                        <p
                          className="mt-4 animate__animated animate__fadeIn animate__slower"
                          style={{
                            color: "#333",
                            fontWeight: "500",
                            fontSize: "1.1rem",
                        ...
                        >
                          <span style={{ color: "#00b14f" }}>AI</span> đang tìm
                          việc làm phù hợp với bạn...
                        </p>
                        ...
                        <p className="text-muted small mt-2 fst-italic">
                          Kết quả sẽ hiển thị trong vài giây...
                        </p>
                      </div>
                    ) : jobPosts.length > 0 ? (
                      jobPosts.map((job) => (
                        <Card
                          key={job.id}
                          className={`mb-3 ${styles["job-card"]} ${
                            job.highlightType === "TopMax"
                              ? styles["topmax-job-card"]
                              : job.highlightType === "TopPro"
                              ? styles["toppro-job-card"]
                              : job.employerIsPro
                          ...
                          style={{
                            boxShadow: job.highlightType
                              ? "0 4px 15px rgba(0,0,0,0.08)"
                              : "0 2px 8px rgba(0,0,0,0.04)",
                            background:
                              job.highlightType === "TopMax"
                                ? "linear-gradient(to right, #fff9f9, #fff)"
                                : job.highlightType === "TopPro"
                                ? "linear-gradient(to right, #f9fcff, #fff)"
                                : job.employerIsPro
                                ? "linear-gradient(to right, #f9fcff, #fff)"
                                : "#fff",
                            borderRadius: "14px",
                          ...
                          <Card.Body className="p-1">
                            <Row>
                              ...
                              >
                                {job.companyLogo ? (
                                  <div
                                    className={`${styles["logo-container"]} ${styles["company-logo-wrapper"]} bg-white d-flex align-items-center justify-content-center`}
                                    style={{
                                      width: "90px",
                                      height: "90px",
                                      borderRadius: "12px",
                                  ...
                                  <div
                                    className={`${styles["logo-container"]} ${styles["company-logo-wrapper"]} bg-light d-flex align-items-center justify-content-center`}
                                    style={{
                                      width: "90px",
                                      height: "90px",
                                      borderRadius: "12px",
                                      ...
                                      overflow: "hidden",
                                      background:
                                        "linear-gradient(45deg, #f9f9f9, #f0f0f0)",
                                    }}
                                  >
                                    <i
                              ...
                              <Col md={10}>
                                <div className="d-flex justify-content-between align-items-start flex-wrap flex-md-nowrap">
                                  <div>
                                    <h5
                                      className={`fw-bold mb-2 ${styles["job-title"]}`}
                                      style={{
                                        fontSize: "1.2rem",
                                        lineHeight: "1.4",
                                        position: "relative",
                                    ...
                                    <div className="d-flex align-items-center mb-2">
                                      ...
                                      {(job.averageRating > 0 ||
                                        ...
                                        <div className="ms-2 d-flex align-items-center gap-2">
                                          {job.averageRating > 0 && (
                                            <span
                                              className="badge bg-warning bg-opacity-10 text-warning px-2 py-1 rounded-pill"
                                              style={{
                                                fontSize: "12px",
                                                fontWeight: "500",
                                              }}
                                  ...
                                  <div className="ms-md-3 mb-2">
                                    {job.highlightType === "TopMax" && (
                                      <span
                                        className={`badge rounded-pill ms-2 d-flex align-items-center ${styles["topmax-badge"]} animate__animated animate__fadeInRight`}
                                        style={{
                                          fontSize: "0.75rem",
                                          padding: "5px 12px",
                                          fontWeight: "600",
                                      ...
                                      >
                                        <i className="bi bi-stars me-1"></i> Top
                                        Max
                                      </span>
                                    )}
                                    {job.highlightType === "TopPro" && (
                                      <span
                                        className={`badge rounded-pill ms-2 d-flex align-items-center ${styles["toppro-badge"]} animate__animated animate__fadeInRight`}
                                        style={{
                                          fontSize: "0.75rem",
                                          padding: "5px 12px",
                                          fontWeight: "600",
                                    ...
                                    {!job.highlightType &&
                                      job.employerIsPro && (
                                        <span
                                          className="badge bg-info rounded-pill ms-2 d-flex align-items-center"
                                          style={{
                                            fontSize: "0.75rem",
                                            padding: "5px 12px",
                                            boxShadow:
                                              "0 2px 5px rgba(13, 202, 240, 0.3)",
                                          }}
                                        >
                                ...
                                <div className="d-flex flex-wrap gap-2">
                                  {job.salary && (
                                    <div
                                      className={`${styles["job-info-tag"]} ${styles["salary-tag"]}`}
                                    >
                                  ...
                                  {job.location && (
                                    <div
                                      className={`${styles["job-info-tag"]} ${styles["location-tag"]}`}
                                    >
                                  ...
                                  {job.employmentType && (
                                    <div
                                      className={`${styles["job-info-tag"]} ${styles["employment-tag"]}`}
                                    >
                                ...
                                <div className="d-flex flex-wrap gap-2">
                                  {job.dueDate && (
                                    <div
                                      className={`${styles["job-info-tag"]} ${styles["date-tag"]} d-flex align-items-center`}
                                      data-tooltip={`Hạn nộp hồ sơ: ${new Date(
                                        job.dueDate
                                  ...
                                  {job.experience && (
                                    <div
                                      className={`${styles["job-info-tag"]} ${styles["experience-tag"]}`}
                                    >
                                ...
                                <div
                                  className={` ${styles["job-card-footer"]}`}
                                >
                                  <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <span
                                      className={`${styles["post-date-badge"]} d-flex align-items-center`}
                                      style={{
                                        fontSize: "0.85rem",
                                        fontWeight: "400",
                                        padding: "6px 12px",
                      ...
                      <div className="text-center py-5 my-4">
                        <div className={`${styles["fade-in-scale"]}`}>
                          ...
                          >
                            Rất tiếc, chúng tôi không tìm thấy việc làm nào phù
                            hợp với bộ lọc hiện tại. Vui lòng thử lại với từ
                            khóa hoặc bộ lọc khác để có nhiều kết quả hơn.
                          </p>
                          <div className="mt-4 d-flex gap-3 justify-content-center">
                            ...
                            >
                              <i className="bi bi-arrow-repeat me-2"></i> Xóa bộ
                              lọc và thử lại
                            </Button>
                          </div>
                  ...
                  {totalCount > pageSize && (
                    <Row className="mt-4 pt-4 border-top">
                      ...
                      >
                        <div
                          className="d-flex align-items-center bg-light px-3 py-2 rounded-pill border"
                          style={{ gap: "8px" }}
                        >
                          <span
                      ...
                      >
                        <Pagination
                          className={`mb-0 shadow-sm ${styles["pagination"]}`}
                          style={{ gap: "5px", borderRadius: "30px" }}
                        >
                      ...
                      <Col xs={12} className="mt-3 text-center">
                        <span
                          className="badge bg-light text-muted px-3 py-2 rounded-pill"
                          style={{ fontSize: "14px" }}
                        >
                          <i
                          ...
                          ></i>
                          Trang{" "}
                          <span className="text-dark fw-medium">{page}</span> /{" "}
              ...
              {jobPosts.length > 0 && (
                <Card
                  className={`mt-4 shadow ${styles["hover-shadow"]}`}
                  style={{ borderRadius: "16px", overflow: "hidden" }}
                >
                    ...
                    <Row className="g-0">
                      <Col md={8}>
                        <div className="p-4">
                          ...
                          <ul
                            className="text-muted"
                            style={{ paddingLeft: "1.2rem", fontSize: "15px" }}
                          >
                            <li className="mb-3">
                              <strong className="text-dark">
                                Sử dụng từ khóa cụ thể
                              </strong>
                              : Tìm kiếm với các từ khóa liên quan trực tiếp đến
                              kỹ năng, chức danh hoặc ngành nghề bạn quan tâm
                            </li>
                            <li className="mb-3">
                              <strong className="text-dark">
                                Kết hợp nhiều bộ lọc
                              </strong>
                              : Sử dụng kết hợp các bộ lọc về địa điểm, mức
                              lương và hình thức làm việc để thu hẹp kết quả
                            </li>
                            <li>
                              <strong className="text-dark">
                                Cập nhật hồ sơ thường xuyên
                              </strong>
                              : Hồ sơ cập nhật mới giúp tăng tỷ lệ tiếp cận từ
                              nhà tuyển dụng và nâng cao cơ hội nhận được lời
                              mời phỏng vấn
                            </li>
                          </ul>
                          <div className="mt-4">
                            ...
                            >
                              <i className="bi bi-arrow-right me-1"></i> Xem
                              thêm mẹo tìm việc
                            </Button>
                          </div>
                        </div>
                      ...
                      <Col
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, #e6f2ff, #f0f7ff)",
                          display: "flex",
                          alignItems: "center",
                      ...
                      >
                        <div className="text-center p-4">
                          ...
                          <p className="text-muted small mb-0">
                            Hồ sơ hoàn thiện có tỷ lệ ứng tuyển thành công cao
                            hơn 80%
                          </p>
                        </div>
                      </Col>
